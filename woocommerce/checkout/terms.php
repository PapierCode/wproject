	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<?php if ( wc_terms_and_conditions_checkbox_enabled() ) : ?>
			<p class="form-row validate-required">
				...
				<?php /* [PC] + */ ?>
				<div class="pc-woo-msg-personal-data">Les données personnelles saisies pour cette commande nous sont réservées et ne seront pas cédées ou revendues à des tiers.</div>
